...
def parse_args():
    ...
    parser.add_argument('--config', default='configs/detection/ava/slowfast_temporal_max_kinetics_pretrained_r50_8x8x1_cosine_10e_ava22_rgb.py',help='test config file path')
    parser.add_argument('--checkpoint', default='checkpoints/slowfast_temporal_max_kinetics_pretrained_r50_8x8x1_cosine_10e_ava22_rgb.pth',help='checkpoint file')
    parser.add_argument('--show', action='store_true', help='show onnx graph')
    parser.add_argument('--output-file', type=str, default='slowfast.onnx')
