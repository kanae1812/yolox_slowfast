...
def parse_args():
    ...
    parser.add_argument(
        '--config',
        default=('../configs/detection/ava/slowfast_temporal_max_kinetics_pretrained_r50_8x8x1_cosine_10e_ava22_rgb.py'),
        help='spatio temporal detection config file path')
    parser.add_argument(
        '--checkpoint',
        default=('../checkpoints/slowfast_temporal_max_kinetics_pretrained_r50_8x8x1_cosine_10e_ava22_rgb.pth'),
        help='spatio temporal detection checkpoint file/url')
    parser.add_argument(
        '--det-config',
        default='../configs/detet/yolox/yolox_s_8x8_300e_coco.py',
        help='human detection config file path (from mmdet)')
    parser.add_argument(
        '--det-checkpoint',
        default=('../checkpoints/yolox_s_8x8_300e_coco_20211121_095711-4592a793.pth'),
    ...
    parser.add_argument('--video', default='/home/kanae/mmaction2/scene/3.mp4',help='video file/url')
    parser.add_argument(
        '--label-map',
        default='/home/kanae/mmaction2/tools/data/ava/abnormal_map.txt',
        help='label map file')
    parser.add_argument(
